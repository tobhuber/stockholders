...
\subsection{Neural Networks}
	A 'feed-forward' (nodes do not form a cycle) network consists of three parts:
	\begin{itemize}
		\item input layer
		\item hidden layers
		\item output layer
	...
	These interact and nonlinearly transform the data until the output layer aggregates the data
	...
	Because of their high degree of nonlinearity and nonconvexity brute force optimisation is
